        ...
        <Paper elevation={3} sx={{ p: 4, borderRadius: 2 }}>
          ...
          <Box component="ol">
            <li>
              {rtl ? (
                <>
                  <strong>تواصل معنا:</strong> تواصل مع فريق دعم العملاء لدينا على {process.env.VITE_EMAIL_ADDRESS} أو {process.env.VITE_WHATSAPP_NUMBER} مع تفاصيل طلبك وسبب الإرجاع.
                </>
              ) : (
                <>
                  <strong>Contact Us:</strong> Reach out to our customer support team at {process.env.VITE_EMAIL_ADDRESS} or {process.env.VITE_WHATSAPP_NUMBER} with your order details and reason for return.
                </>
              )}
            </li>
            <li>
          ...
          <Box component="ul">
            <li>
              {rtl ? (
                <>
                  إذا كنت ترغب في إلغاء طلبك قبل شحنه، يُرجى الاتصال بنا فورًا على {process.env.VITE_EMAIL_ADDRESS}  أو {process.env.VITE_WHATSAPP_NUMBER}. لا يمكن إلغاء الطلبات التي تم شحنها بالفعل.
                </>
              ) : (
                <>
                  If you wish to cancel your order before it has been shipped, please contact us
                  immediately at {process.env.VITE_EMAIL_ADDRESS} or {process.env.VITE_WHATSAPP_NUMBER}. Orders that have
          ...
          <Typography paragraph>
            {rtl ? (
              <>
                ...
                <br />
                {process.env.VITE_EMAIL_ADDRESS}
              </>
            ) : (
              <>
